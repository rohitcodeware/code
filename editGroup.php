	...
	<div id="profile_Container"><!--profile_Container_div_Open-->
	     <div id="profile_content_main" ><!--content_main_Open-->
		    ...
		    <tr>
				...
				<tr>
				<td colspan="2">
						<div id="profile_menu">&nbsp;<div class="create_group"></div><h3 style="position:relative; top:-40px; font-size:23px; color:#2C2C2C;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;EDIT GROUP</h3>
						</div>
				</td>
				</tr>
					...
					<td class="vertical_top" id="profile_form" colspan="2">
							...
							<form method="" action="" enctype="multipart/form-data"><!--plug_edit_form_open-->
									...
									<tr>
										...
										<td class="td2_width"><input type="text" name="" class="text" value="Camping" onClick="if(this.value=='Enter your group name'){this.value=''}" onBlur="if(this.value==''){this.value='Enter your group name'}" style="color:#999;"/></td>
									</tr>
                                    <tr>
										<td class="td1_width"><label style="top:-35px; position:relative;">Description :</label></td>
										<td class="td2_width"><textarea  name="" class="textarea"   value="" onClick="if(this.value=='Enter your group description'){this.value=''}" onBlur="if(this.value==''){this.value='Enter your group description'}" style="color:#999; font-size:12px; font-family:Arial, Helvetica, sans-serif;">Enter your group description</textarea></td>
									</tr>
                                    <tr>
										<td class="td1_width"><label>Add Member :</label></td>
										<td class="td2_width"><input type="text" name="" class="text"  value="" onClick="if(this.value=='Member you want to add to group'){this.value=''}" onBlur="if(this.value==''){this.value='Member you want to add to group'}"style="color:#999;"/></td>
									</tr>
                                     <tr>
					...
					<table class="form_button" style="float:; width:56%;"><!--button_table_open-->
							<tr>
								<td class="padding_button">
                                        <input type="submit" name="save" class="plug_save_button" value="" title="Save"/>
