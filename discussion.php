				...
				<tr><!--main_table_tr_open-->
					...
					<td id="td_right"><!--td_right_Open-->
						<table cellspacing="0"><!--top1_table_open-->
							<tr>
							<td id="create_menu"><!--create_menu_Open-->
								<ol>
									<li style="width:100%;"><img src="images/picture_04.jpg" style="display:inline-block; width:15px; height:auto;" />&nbsp;<label><a href="newPlug.php">CREATE  PLUG</a></label>&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/picture_06.jpg" style="display:inline-block; width:15px; height:auto;" />&nbsp;<label><a href="discussion.php">CREATE  DISCUSSION</a></label></li>
								</ol>
					...
					<td colspan="2">
						...
						<?php include('include/discussion_data.php'); ?>
